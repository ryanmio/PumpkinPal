...
├── functions
│   ├── bigpumpkins.csv
│   ├── bigpumpkins_2004_2022.csv
│   ├── functionsguide.md
│   ├── import-contests-only.py
│   ├── import-script.py
│   ├── index.js
│   ├── name_changes.csv
│   ├── package-lock.json
│   ├── package.json
│   ├── preprocessed-bigpumpkins.csv
│   ├── preprocessor.py
│   ├── pumpkinpal-b60be-firebase-adminsdk-jtia5-63bbe231d8.json
│   └── scrape_bigpumpkins.py
├── package-lock.json
├── package.json
├── public
│   ├── _redirects
...
│   │   ├── GraphCard.js
│   │   ├── GrowerStatsProfile
│   │   │   ├── CloudFunctionTrigger.js
│   │   │   ├── GrowerSearch.js
│   │   │   ├── GrowerStatsProfile.js
│   │   │   ├── Header.js
│   │   │   ├── MyStats.js
│   │   │   ├── PumpkinDetails.js
│   │   │   ├── Search.js
...
│   └── utilities
│       ├── Button.js
│       ├── GoogleAnalyticsGuide.md
│       ├── error-analytics.js
│       ├── fetchGrowerData.js
│       ├── fetchPumpkins.js
│       ├── getGrowerSuggestions.js
│       ├── uploadImage.js
│       └── useGrowerDataHook.js
└── tailwind.config.js
```
