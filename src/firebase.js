...
import { getFirestore, Timestamp, query as firestoreQuery, orderBy, limit } from "firebase/firestore";
...
export const orderByFirestore = orderBy;
export const limitFirestore = limit;
