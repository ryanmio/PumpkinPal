  ...
  <div className="container mx-auto px-4">
    ...
    {email && (
      <>
        ...
        <div className="my-8">
          <button className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-1/2 mx-auto mb-4" onClick={() => navigate('/add-pumpkin')}>Add Pumpkin</button>
        </div>
      </>
    )}
  </div>
