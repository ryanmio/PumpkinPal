          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="mb-4 text-sm text-gray-600">
                Maternal Lineage: {pumpkin.maternalLineage}
              </p>
              <p className="mb-4 text-sm text-gray-600">
                Paternal Lineage: {pumpkin.paternalLineage}
              </p>
              ...
              {pumpkin.pollinated && (
                <p className="mb-4 text-sm text-gray-600">
                  Pollinated Date: {pumpkin.pollinated}
                </p>
              )}
              {pumpkin.daysAfterPollination && (
                <p className="mb-4 text-sm text-gray-600">
                  Days After Pollination: {pumpkin.daysAfterPollination} days
                </p>
              )}
              <div className="mt-4">
                <button
                  ...
                  onClick={() =>
                    navigate(`/add-measurement/${pumpkin.id}`)
                  }
                >
                  Add Measurement
                </button>
