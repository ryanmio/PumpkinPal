...
function Logout() {
  ...
  return (
    <button
      ...
      className="relative px-4 py-1 text-sm font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group focus:outline-none whitespace-nowrap" // Added whitespace-nowrap and adjusted padding
      style={{ '--hover-bg-color': '#4A4F40', minWidth: '80px' }} // Added custom property for hover background color and minimum width
    >
