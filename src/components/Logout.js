...
function Logout() {
  const handleLogout = async () => {
    try {
      ...
      // After successful sign out, reload the page or redirect using window.location
  ...
  return (
    <button onClick={handleLogout} className="logout-button relative px-2 py-1 text-sm font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group focus:outline-none whitespace-nowrap overflow-hidden"
