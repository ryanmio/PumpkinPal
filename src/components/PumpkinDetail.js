...
return (
      ...
      <div className="mb-2 text-sm text-left">
        <Link to="/dashboard" className="text-gray-700 hover:text-gray-900 transition duration-150 ease-in-out text-decoration-none">
      ...
      <div className="bg-white shadow rounded-lg p-4 flex flex-col">
        ...
        <div className="bg-white shadow rounded-lg p-4 flex flex-col">
          <div className="mb-auto">
            ...
            <p><b>Weigh-off:</b> {pumpkin?.weighOff ? `${pumpkin?.weighOff} (#${daysUntilWeighOff(pumpkin?.weighOff) === 'Not Set' ? 'Not Set' : daysUntilWeighOff(pumpkin?.weighOff) + ' days'})` : 'Not Set'}</p>
          </div>
