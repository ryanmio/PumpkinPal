...
function Sidebar() {
  ...
  return (
    <>
      ...
      <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
      ...
      <main className={`transition-margin ${isOpen ? 'ml-64' : 'ml-0'} sm:ml-64`}>
