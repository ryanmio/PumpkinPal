...
function Sidebar() {
  ...
  return (
    <div className={`flex ${isOpen ? 'ml-64' : 'ml-0'} transition-all duration-300`}>
      <button
      ...
      <aside id="default-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`} aria-label="Sidebar">
