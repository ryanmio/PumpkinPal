...
const ImageCard = ({ pumpkinId }) => {
  ...
  <div className="bg-white shadow rounded-lg p-4 md:col-span-2 flex flex-col overflow-x-auto mb-12">
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <label className="w-full h-64 flex justify-center items-center border-2 border-dashed border-gray-400 rounded cursor-pointer hover:bg-gray-100 aspect-w-1 aspect-h-1">
        <input
          type="file"
          accept="image/*"
          capture="environment"
