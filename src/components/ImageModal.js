...
React.useEffect(() => {
  ...
  className={`flex flex-col items-center justify-center bg-white rounded-lg p-4 max-w-lg mx-auto mt-20 ${isFullscreen ? 'fixed top-0 left-0 w-screen h-screen z-50' : ''}`}
>
