'use client'
// app/edit-measurement/[pumpkinId]/[measurementId]/page.js
        ...
        <div className="bg-white shadow overflow-hidden rounded-lg p-4 w-full md:max-w-md mx-auto">
          ...
          <form onSubmit={editMeasurement} className="space-y-4">
            ...
            <div className="flex justify-between items-center mt-4">
              <button type="button" onClick={() => router.push(`/pumpkin/${pumpkinId}`)} className="text-blue-600 hover:underline">Cancel</button>
