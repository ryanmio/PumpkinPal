        ...
        if (docSnap.exists()) {
          ...
          const popularityData = {
              ...
              datasets: [{
                ...
                pointRadius: 5,
                pointHoverRadius: 7,
                pointLabel: Object.values(data['Popularity by Year']).toString(),
              }],
            };
          const weightData = {
              ...
              datasets: [{
                ...
                pointRadius: 5,
                pointHoverRadius: 7,
                pointLabel: Object.values(data['Max Weight by Year']).toString(),
              }],
            };
  ...
  <div className="min-h-screen flex justify-start flex-col">
    <div className="container mx-auto px-4 pt-10 flex flex-col space-y-4">
      <div className="text-left">
        {user && (
          <Link href="#" onClick={() => router.back()} className="text-gray-700 hover:text-gray-900 transition duration-150 ease-in-out">Back</Link>
        )}
      </div>
